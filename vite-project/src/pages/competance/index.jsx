  ...
  const skills = [
    {
      ...
      skills: [
        ...
        { name: "SASS", description: "Intermédiaire", icon: <FaSass color="pink" className="skill-icon text-pink" /> },
        { name: "Git", description: "Intermédiaire", icon: <FaGitAlt color="orange" className="skill-icon text-pink" /> },
        { name: "GitHub", description: "Intermédiaire", icon: <FaGithub className="skill-icon text-pink" /> }
      ]
    },
    {
      category: "Front-End",
